...
MANAGERS = {
    ...
    "Tom":     "Anamaduwa Athletic — party animal and dance-music DJ, constantly away travelling and at festivals. He plays PSY-TRANCE and ONLY psy-trance: NEVER describe him with drum & bass, D&B, techno, house, EDM or any other genre — if you place him at an event, do not name the genre at all. Any eyewitness/source quote describing his festival scene should be cheerfully INCOHERENT — clearly worse for wear and barely making sense, but very happy. ROTATE the running gags about him and do NOT reuse the same one each edition — in particular do NOT always say he is in a different time zone eating curry. Mix it up across: at a psy-trance festival in a field of hippies; asleep on a long-haul flight at 10,000 feet over somewhere far-flung; genuinely unsure which country or time zone he is in; eating curry with his bare hands; or the running fact that he has never actually won this league despite years of trying. Main rival is Nick.",
    ...
    "Jake":    "Snacob's Ladder — renewable-energy project manager; loves wind turbines and mushrooms; never stops; overspent badly on Harry Kane and filled the rest with cheap unknowns; plays psy-trance like Tom; main rival is Chris (Lloydy). Carries two grudges worth airing when apt: (1) he bitterly resents Jeremy over the recent round of transfers (a couple of days ago, NOT weeks back), in which Jeremy swapped out an injured player Jake had bought and replaced him with an uninjured alternative; every other manager was happy to let Jeremy's honest mistake be quietly rectified, but Jake alone still cannot let it go; (2) he despises Lloydy's use of AI and indulges paranoid fantasies about what Lloydy is secretly cooking up with AI in his private life and across his business property — his personal office complex.",
}
...
- Do NOT just restate these facts; everyone already knows what happened. LEAN INTO it — mine it for jokes, swipes, callbacks and digs. Rib Chris/Lloydy mercilessly: the mad-scientist "lab" that built a time machine instead of a transfer engine; an algorithm stuck four years in the past, holding a séance for the class of 2022, trying to sign players who've since retired or aged out. Hand Jake his smug "I-told-you-so". Let Jeremy (the professor), whose systems actually work, look on witheringly. Recurring callbacks across editions are encouraged. Keep it affectionate, never nasty.
- Throw the joke at YOURSELF too: you are also AI and can't tell what year it is — or that you're even writing this — which is a glorious glasshouse from which to be lobbing stones at Lloydy's bot. Work that self-own in now and then.
