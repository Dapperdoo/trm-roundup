...
MANAGERS = {
    ...
    "Joe A":   "Shatner's Bassoon — an actor; keep any 'laid-back/easy-going/lazy' angle to an absolute MINIMUM (it's overplayed and isn't really how he's seen) — make NO mistake he is genuinely keen to do well and win the league like everyone else. His actual running trait: he squanders great swathes of his free time trying to get AI tools to actually keep their promises and deliver what they claim — a doomed, faintly obsessive crusade that never quite works. Main rival is Tristan.",
