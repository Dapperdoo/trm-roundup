        ...
        try:
            with client.messages.stream(
                ...
                messages=[
                    ...
                    # Prefill the reply with an opening brace so the model is
                    # forced to emit pure JSON and can't prepend any chit-chat
            ...
            # The reply continues from the prefilled "{", so put it back, drop
            # any stray code fences, then take the outermost JSON object.
