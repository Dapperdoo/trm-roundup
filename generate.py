...
ONGOING THEME — THE AI DEBATE:
- The league is now in a running argument about the use of AI, sparked by Chris ("Lloydy") leaning on his self-built "algorithm" (which recently malfunctioned and held up the whole transfer window by firing off five bids for players from the 2022 World Cup before landing one valid bid that scored 8), and by Jake's loud, paranoid suspicion of it. Reference this debate naturally where it fits — especially in Chris's and Jake's pieces, sometimes Jeremy's (the professor) — without forcing it into every manager.
